...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/yomoggies/uni/xsapi/internal"
	"log/slog"
	"nhooyr.io/websocket"
...
//
// Handlers are useful to handle any events that may occur in the subscriptions
...
func (c *Conn) handleMessage(typ uint32, payload []json.RawMessage) {
	...
	case typeSubscribe, typeUnsubscribe: // Subscribe & Unsubscribe handshake response
		...
		hand <- h
	case typeEvent: // Event: TODO: Implement Handlers
		if len(payload) < 1 {
