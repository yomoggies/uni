...
func TestOggReader_ParseErrors(t *testing.T) {
	...
	t.Run("Invalid ConnectionID Page Header Signature", func(t *testing.T) {
	...
	t.Run("Invalid ConnectionID Page Header Type", func(t *testing.T) {
		ogg := buildOggContainer()
		ogg[5] = 0
	...
	t.Run("Invalid ConnectionID Page Payload Length", func(t *testing.T) {
		ogg := buildOggContainer()
		ogg[27] = 0
