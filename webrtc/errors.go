...
var (
	...
	// ErrMaxDataChannelID indicates that the maximum number ConnectionID that could be
	// specified for a data channel has been exceeded.
	ErrMaxDataChannelID = errors.New("maximum number ConnectionID for datachannel specified")
	...
	// the negotiated channel ConnectionID.
