...
// StatsReport collects Stats objects indexed by their ConnectionID.
...
// They will have the same "TrackIdentifier" attribute, but different "ConnectionID" attributes.
//
