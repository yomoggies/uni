...
// Assert that renegotiation triggers OnTrack() with correct ConnectionID and label from
...
// track later and renegotiate, and track ConnectionID and label will be set by the time
